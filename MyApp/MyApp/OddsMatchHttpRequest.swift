...
class OddsMatchHttpRequest {
	...
	func getOddsRisultatoFinaleForMatch(){
		...
		let match = homeTeam!.lowercaseString.stringByReplacingOccurrencesOfString(" ", withString: "-") + "-" + awayTeam!.lowercaseString.stringByReplacingOccurrencesOfString(" ", withString: "-")
